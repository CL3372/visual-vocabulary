...
export const EASTERN_EUROPEAN_INGREDIENT_WORDS: Word[] = [
  ...
  // ── Herbs & Spices ────────────────────────────────────────────────────────────
  { id: 'eei12', word: 'Fenugreek Leaf', translations: { es: 'Hoja de fenogreco', pt: 'Folha de feno-grego', fr: 'Feuille de fenugrec', de: 'Bockshornklee-Blatt', it: 'Foglia di fieno greco', ja: 'フェヌグリーク葉', zh: '葫芦巴叶', ko: '호로파잎', ar: 'ورق الحلبة' , hi: 'मेथी की पत्तियाँ', ru: 'Листья пажитника', tr: 'Çemen Otu Yaprağı'}, category: 'Herbs & Spices', unsplashQuery: 'fenugreek leaf herb Georgian cooking' },
  { id: 'eei13', word: 'Blue Fenugreek', translations: { es: 'Fenogreco azul',  pt: 'Feno-grego azul', fr: 'Fenugrec bleu',   de: 'Blauer Bockshornklee', it: 'Fieno greco blu', ja: 'ブルーフェヌグリーク', zh: '蓝葫芦巴', ko: '블루 호로파', ar: 'حلبة زرقاء' , hi: 'नीला मेथी', ru: 'Голубой пажитник', tr: 'Mavi Çemen'}, category: 'Herbs & Spices', unsplashQuery: 'blue fenugreek Georgian spice utskho suneli' },
