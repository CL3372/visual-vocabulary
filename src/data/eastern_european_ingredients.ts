...
export const EASTERN_EUROPEAN_INGREDIENT_WORDS: Word[] = [
  ...
  { id: 'eei9', word: 'Horseradish',    translations: { es: 'Rábano picante', pt: 'Rábano picante',  fr: 'Raifort',         de: 'Meerrettich',     it: 'Rafano',          ja: 'ホースラディッシュ', zh: '辣根',     ko: '서양 고추냉이', ar: 'فجل حار' }, category: 'Condiments', unsplashQuery: 'horseradish root grated white' },
