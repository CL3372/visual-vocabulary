...
export const EUROPEAN_INGREDIENT_WORDS: Word[] = [
  ...
  { id: 'ei4',  word: 'Vine Leaves',    translations: { es: 'Hojas de parra',  pt: 'Folhas de uva',  fr: 'Feuilles de vigne', de: 'Weinblätter',        it: 'Foglie di vite',     ja: 'ぶどうの葉',           zh: '葡萄叶',    ko: '포도잎', ar: 'ورق العنب' }, category: 'Vegetables', unsplashQuery: 'grape vine leaves fresh green stack Mediterranean' },
  ...
  { id: 'ei10', word: 'Juniper Berries', translations: { es: 'Bayas de enebro', pt: 'Bagas de zimbro', fr: 'Baies de genièvre', de: 'Wacholderbeeren',   it: 'Bacche di ginepro',  ja: 'ジュニパーベリー',     zh: '杜松子',    ko: '주니퍼베리', ar: 'توت العرعر' , hi: 'जुनियर बेरीज़', ru: 'Ягоды можжевельника', tr: 'Ardıç Meyveleri', pl: 'Jagody jałowca', cs: 'Bobule jalovce', ro: 'Boabe de ienupăr'}, category: 'Herbs & Spices', unsplashQuery: 'juniper berries blue gin spice' },
  ...
  { id: 'ei25', word: 'Veal',           translations: { es: 'Ternera',         pt: 'Vitela',         fr: 'Veau',              de: 'Kalbfleisch',        it: 'Vitello',            ja: '仔牛',                 zh: '小牛肉',    ko: '송아지고기', ar: 'لحم العجل' }, category: 'Meat', unsplashQuery: 'veal escalope milanese breaded golden cutlet italian' },
