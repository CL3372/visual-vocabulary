...
export const EUROPEAN_INGREDIENT_WORDS: Word[] = [
  ...
  { id: 'ei10', word: 'Juniper Berries', translations: { es: 'Bayas de enebro', pt: 'Bagas de zimbro', fr: 'Baies de genièvre', de: 'Wacholderbeeren',   it: 'Bacche di ginepro',  ja: 'ジュニパーベリー',     zh: '杜松子',    ko: '주니퍼베리', ar: 'توت العرعر' , hi: 'जुनियर बेरीज़', ru: 'Ягоды можжевельника', tr: 'Ardıç Meyveleri'}, category: 'Herbs & Spices', unsplashQuery: 'juniper berries blue gin spice' },
