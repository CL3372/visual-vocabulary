...
export const WORDS: Word[] = [
  // Animals
  { id: '1', word: 'Cat', translations: { es: 'Gato', pt: 'Gato', fr: 'Chat', de: 'Katze', it: 'Gatto', ja: 'ネコ', zh: '猫', ko: '고양이', ar: 'قطة' , hi: 'बिल्ली', ru: 'Кот', tr: 'Kedi', pl: 'Kot', cs: 'Kočka', ro: 'Pisică'}, category: 'Animals', unsplashQuery: 'cat', sentence: 'The cat is a small, independent domesticated mammal kept as a beloved pet around the world.' },
  { id: '2', word: 'Dog', translations: { es: 'Perro', pt: 'Cachorro', fr: 'Chien', de: 'Hund', it: 'Cane', ja: '犬', zh: '狗', ko: '개', ar: 'كلب' , hi: 'कुत्ता', ru: 'Собака', tr: 'Köpek', pl: 'Pies', cs: 'Pes', ro: 'Câine'}, category: 'Animals', unsplashQuery: 'dog', sentence: 'The dog is one of humanity\'s oldest companions, known for its loyalty, intelligence, and wide variety of breeds.' },
  { id: '3', word: 'Bird', translations: { es: 'Pájaro', pt: 'Pássaro', fr: 'Oiseau', de: 'Vogel', it: 'Uccello', ja: '鳥', zh: '鸟', ko: '새', ar: 'طائر' , hi: 'पक्षी', ru: 'Птица', tr: 'Kuş', pl: 'Ptak', cs: 'Pták', ro: 'Pasăre'}, category: 'Animals', unsplashQuery: 'bird nature', sentence: 'Birds are feathered, warm-blooded animals with wings found on every continent, ranging from tiny hummingbirds to large ostriches.' },
  { id: '4', word: 'Fish', translations: { es: 'Pez', pt: 'Peixe', fr: 'Poisson', de: 'Fisch', it: 'Pesce', ja: '魚', zh: '鱼', ko: '생선', ar: 'سمك' , hi: 'मछली', ru: 'Рыба', tr: 'Balık', pl: 'Ryby', cs: 'Ryby', ro: 'Pește'}, category: 'Animals', unsplashQuery: 'fish ocean', sentence: 'Fish are aquatic vertebrates that breathe through gills and live in oceans, rivers, and lakes across the globe.' },
  { id: '5', word: 'Horse', translations: { es: 'Caballo', pt: 'Cavalo', fr: 'Cheval', de: 'Pferd', it: 'Cavallo', ja: '馬', zh: '马', ko: '말', ar: 'حصان' , hi: 'घोड़ा', ru: 'Лошадь', tr: 'At', pl: 'Koń', cs: 'Kůň', ro: 'Cal'}, category: 'Animals', unsplashQuery: 'horse', sentence: 'The horse is a large, powerful mammal that has worked alongside humans for thousands of years in transport, farming, and sport.' },
  ...
  { id: '49', word: 'River', translations: { es: 'Río', pt: 'Rio', fr: 'Rivière', de: 'Fluss', it: 'Fiume', ja: '川', zh: '河流', ko: '강', ar: 'نهر' , hi: 'नदी', ru: 'Река', tr: 'Nehir', pl: 'Rzeka', cs: 'Řeka', ro: 'Râu'}, category: 'Nature', unsplashQuery: 'river', sentence: 'A river is a large natural stream of fresh water flowing toward the sea, shaping landscapes and providing water for civilizations throughout history.' },
  { id: '50', word: 'Forest', translations: { es: 'Bosque', pt: 'Floresta', fr: 'Forêt', de: 'Wald', it: 'Foresta', ja: '森', zh: '森林', ko: '숲', ar: 'غابة' , hi: 'वन', ru: 'Лес', tr: 'Orman', pl: 'Las', cs: 'Les', ro: 'Pădure'}, category: 'Nature', unsplashQuery: 'forest', sentence: 'A forest is a dense area of trees and undergrowth covering vast regions of the earth, home to the majority of the planet\'s land-based biodiversity.' },
  ...
  { id: '55', word: 'Bed', translations: { es: 'Cama', pt: 'Cama', fr: 'Lit', de: 'Bett', it: 'Letto', ja: 'ベッド', zh: '床', ko: '침대', ar: 'سرير' , hi: 'बिस्तर', ru: 'Кровать', tr: 'Yatak', pl: 'Łóżko', cs: 'Postel', ro: 'Pat'}, category: 'Home', unsplashQuery: 'bed bedroom', sentence: 'A bed is a piece of furniture designed for sleeping, typically consisting of a mattress on a frame, found in every home across the world.' },
  { id: '56', word: 'Door', translations: { es: 'Puerta', pt: 'Porta', fr: 'Porte', de: 'Tür', it: 'Porta', ja: 'ドア', zh: '门', ko: '문', ar: 'باب' , hi: 'दरवाज़ा', ru: 'Дверь', tr: 'Kapı', pl: 'Drzwi', cs: 'Dveře', ro: 'Ușă'}, category: 'Home', unsplashQuery: 'door entrance', sentence: 'A door is a movable barrier used to open and close the entrance of a building or room, providing privacy, security, and shelter.' },
  { id: '57', word: 'Window', translations: { es: 'Ventana', pt: 'Janela', fr: 'Fenêtre', de: 'Fenster', it: 'Finestra', ja: '窓', zh: '窗户', ko: '창문', ar: 'نافذة' , hi: 'खिड़की', ru: 'Окно', tr: 'Pencere', pl: 'Okno', cs: 'Okno', ro: 'Fereastră'}, category: 'Home', unsplashQuery: 'window light', sentence: 'A window is an opening in a wall fitted with glass, allowing natural light and ventilation into a building while keeping out weather.' },
  { id: '58', word: 'Book', translations: { es: 'Libro', pt: 'Livro', fr: 'Livre', de: 'Buch', it: 'Libro', ja: '本', zh: '书', ko: '책', ar: 'كتاب' , hi: 'पुस्तक', ru: 'Книга', tr: 'Kitap', pl: 'Książka', cs: 'Kniha', ro: 'Carte'}, category: 'Home', unsplashQuery: 'book reading', sentence: 'A book is a collection of written or printed pages bound together, one of humanity\'s most important inventions for sharing knowledge and stories.' },
  ...
  { id: '60', word: 'Sofa', translations: { es: 'Sofá', pt: 'Sofá', fr: 'Canapé', de: 'Sofa', it: 'Divano', ja: 'ソファ', zh: '沙发', ko: '소파', ar: 'أريكة' , hi: 'सोफा', ru: 'Диван', tr: 'Kanepe', pl: 'Sofa', cs: 'Pohovka', ro: 'Canapea'}, category: 'Home', unsplashQuery: 'sofa couch', sentence: 'A sofa is a comfortable upholstered seat with arms and a back, designed for multiple people to sit or lounge on together in a living room.' },
  ...
  { id: '62', word: 'Clock', translations: { es: 'Reloj', pt: 'Relógio', fr: 'Horloge', de: 'Uhr', it: 'Orologio', ja: '時計', zh: '时钟', ko: '시계', ar: 'ساعة' , hi: 'घड़ी', ru: 'Часы', tr: 'Saat', pl: 'Zegar', cs: 'Hodiny', ro: 'Ceas'}, category: 'Home', unsplashQuery: 'clock', sentence: 'A clock is a device that measures and displays time, from ancient sundials and mechanical pendulums to modern digital displays.' },
  ...
  { id: '65', word: 'Airplane', translations: { es: 'Avión', pt: 'Avião', fr: 'Avion', de: 'Flugzeug', it: 'Aereo', ja: '飛行機', zh: '飞机', ko: '비행기', ar: 'طائرة' , hi: 'विमान', ru: 'Самолет', tr: 'Uçak', pl: 'Samolot', cs: 'Letadlo', ro: 'Avion'}, category: 'Transport', unsplashQuery: 'airplane sky', sentence: 'An airplane is a powered aircraft with fixed wings that generates lift, allowing people and cargo to travel across continents in hours.' },
  { id: '66', word: 'Boat', translations: { es: 'Barco', pt: 'Barco', fr: 'Bateau', de: 'Boot', it: 'Barca', ja: 'ボート', zh: '船', ko: '배', ar: 'قارب' , hi: 'नाव', ru: 'Лодка', tr: 'Tekne', pl: 'Łódź', cs: 'Loď', ro: 'Barcă'}, category: 'Transport', unsplashQuery: 'boat water', sentence: 'A boat is a watercraft used to travel across rivers, lakes, and seas, ranging from small rowing boats to large sailing vessels.' },
  { id: '67', word: 'Train', translations: { es: 'Tren', pt: 'Trem', fr: 'Train', de: 'Zug', it: 'Treno', ja: '電車', zh: '火车', ko: '기차', ar: 'قطار' , hi: 'ट्रेन', ru: 'Поезд', tr: 'Tren', pl: 'Pociąg', cs: 'Vlak', ro: 'Tren'}, category: 'Transport', unsplashQuery: 'train railway', sentence: 'A train is a series of connected carriages pulled by a locomotive along rails, offering efficient travel for passengers and freight over long distances.' },
  { id: '68', word: 'Bus', translations: { es: 'Autobús', pt: 'Ônibus', fr: 'Bus', de: 'Bus', it: 'Autobus', ja: 'バス', zh: '公共汽车', ko: '버스', ar: 'حافلة' , hi: 'बस', ru: 'Автобус', tr: 'Otobüs', pl: 'Autobus', cs: 'Autobus', ro: 'Autobuz'}, category: 'Transport', unsplashQuery: 'bus city', sentence: 'A bus is a large road vehicle that carries many passengers along fixed routes, forming the backbone of public transport in cities worldwide.' },
  { id: '69', word: 'Motorcycle', translations: { es: 'Moto', pt: 'Moto', fr: 'Moto', de: 'Motorrad', it: 'Moto', ja: 'バイク', zh: '摩托车', ko: '오토바이', ar: 'دراجة نارية' , hi: 'मोटरसाइकिल', ru: 'Мотоцикл', tr: 'Motosiklet', pl: 'Motocykl', cs: 'Motocykl', ro: 'Motocicletă'}, category: 'Transport', unsplashQuery: 'motorcycle', sentence: 'A motorcycle is a two-wheeled motor vehicle popular for its speed, agility, and fuel efficiency on both city streets and open roads.' },
  ...
  { id: '75', word: 'Purple', translations: { es: 'Morado', pt: 'Roxo', fr: 'Violet', de: 'Lila', it: 'Viola', ja: '紫', zh: '紫色', ko: '보라색', ar: 'بنفسجي' , hi: 'बैंगनी', ru: 'Фиолетовый', tr: 'Mor', pl: 'Fioletowy', cs: 'Fialová', ro: 'Violet'}, category: 'Colors', unsplashQuery: 'purple lavender', sentence: 'Purple is a rich secondary color made by mixing red and blue, historically associated with royalty and luxury due to the rarity of its natural dyes.' },
  ...
  // Clothes
  { id: '87', word: 'Shirt', translations: { es: 'Camisa', pt: 'Camisa', fr: 'Chemise', de: 'Hemd', it: 'Camicia', ja: 'シャツ', zh: '衬衫', ko: '셔츠', ar: 'قميص' , hi: 'शर्ट', ru: 'Рубашка', tr: 'Gömlek', pl: 'Koszula', cs: 'Košile', ro: 'Cămașă'}, category: 'Clothes', unsplashQuery: 'shirt clothing', sentence: 'A shirt is a garment worn on the upper body, with or without a collar and buttons, one of the most universal items of clothing worldwide.' },
  { id: '88', word: 'Shoes', translations: { es: 'Zapatos', pt: 'Sapatos', fr: 'Chaussures', de: 'Schuhe', it: 'Scarpe', ja: '靴', zh: '鞋子', ko: '신발', ar: 'حذاء' , hi: 'जूते', ru: 'Обувь', tr: 'Ayakkabılar', pl: 'Buty', cs: 'Boty', ro: 'Încălțăminte'}, category: 'Clothes', unsplashQuery: 'shoes', sentence: 'Shoes are footwear designed to protect and comfort the feet, made in styles ranging from leather dress shoes and sneakers to sandals and boots.' },
  ...
  { id: '91', word: 'Jacket', translations: { es: 'Chaqueta', pt: 'Jaqueta', fr: 'Veste', de: 'Jacke', it: 'Giacca', ja: 'ジャケット', zh: '夹克', ko: '재킷', ar: 'جاكيت' , hi: 'जैकेट', ru: 'Куртка', tr: 'Ceket', pl: 'Kurtka', cs: 'Bunda', ro: 'Jachetă'}, category: 'Clothes', unsplashQuery: 'jacket', sentence: 'A jacket is an outer garment covering the upper body, worn for warmth and style in materials ranging from denim and leather to wool and down.' },
  { id: '92', word: 'Glasses', translations: { es: 'Gafas', pt: 'Óculos', fr: 'Lunettes', de: 'Brille', it: 'Occhiali', ja: 'メガネ', zh: '眼镜', ko: '안경', ar: 'نظارة' , hi: 'चश्मा', ru: 'Очки', tr: 'Gözlükler', pl: 'Okulary', cs: 'Brýle', ro: 'Ochelari'}, category: 'Clothes', unsplashQuery: 'glasses eyewear', sentence: 'Glasses are frames fitted with lenses worn in front of the eyes to correct vision or protect from sunlight, used by billions worldwide.' },

  // Sports
  { id: '93', word: 'Ball', translations: { es: 'Pelota', pt: 'Bola', fr: 'Ballon', de: 'Ball', it: 'Palla', ja: 'ボール', zh: '球', ko: '공', ar: 'كرة' , hi: 'गेंद', ru: 'Мяч', tr: 'Top', pl: 'Piłka', cs: 'Míč', ro: 'Minge'}, category: 'Sports', unsplashQuery: 'ball sport', sentence: 'A ball is a round object used in dozens of sports and games worldwide, from football and basketball to tennis and cricket.' },
  { id: '94', word: 'Swimming', translations: { es: 'Natación', pt: 'Natação', fr: 'Natation', de: 'Schwimmen', it: 'Nuoto', ja: '水泳', zh: '游泳', ko: '수영', ar: 'سباحة' , hi: 'तैराकी', ru: 'Плавание', tr: 'Yüzme', pl: 'Pływanie', cs: 'Plavání', ro: 'Înot'}, category: 'Sports', unsplashQuery: 'swimming pool', sentence: 'Swimming is a full-body sport and exercise performed in water, enjoyed recreationally and competitively in pools, lakes, and the ocean.' },
  { id: '95', word: 'Football', translations: { es: 'Fútbol', pt: 'Futebol', fr: 'Football', de: 'Fußball', it: 'Calcio', ja: 'サッカー', zh: '足球', ko: '축구', ar: 'كرة القدم' , hi: 'फुटबॉल', ru: 'Футбол', tr: 'Futbol', pl: 'Piłka nożna', cs: 'Fotbal', ro: 'Fotbal'}, category: 'Sports', unsplashQuery: 'football soccer', sentence: 'Football (soccer) is the world\'s most popular sport, played between two teams of eleven who kick a ball into the opposing goal on a large pitch.' },
