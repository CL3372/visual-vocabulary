...
export const WORDS: Word[] = [
  ...
  // Nature
  { id: '41', word: 'Sun', translations: { es: 'Sol', pt: 'Sol', 'pt-br': 'Sol', fr: 'Soleil', de: 'Sonne', it: 'Sole', ja: '太陽', zh: '太阳', ko: '태양', ar: 'شمس' , hi: 'रविवार', ru: 'Воскресенье', tr: 'Pazar', pl: 'Słońce', cs: 'Slunce', ro: 'Soare'}, category: 'Nature', unsplashQuery: 'bright sun yellow sky sunshine clear day', sentence: 'The Sun is the star at the center of our solar system, providing the light and heat that make life on Earth possible.' },
