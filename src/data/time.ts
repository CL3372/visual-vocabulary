...
export const TIME_WORDS: Word[] = [
  ...
  { id: 't10', word: 'March',     translations: { es: 'Marzo',      pt: 'Março',      fr: 'Mars',      de: 'März',        it: 'Marzo',     ja: '3月',  zh: '三月',  ko: '3월',  ar: 'مارس'     }, category: 'Months', unsplashQuery: 'march daffodils yellow spring meadow sunshine bloom' },
  ...
  { id: 't12', word: 'May',       translations: { es: 'Mayo',       pt: 'Maio',       fr: 'Mai',       de: 'Mai',         it: 'Maggio',    ja: '5月',  zh: '五月',  ko: '5월',  ar: 'مايو'     }, category: 'Months', unsplashQuery: 'may blossom cherry tree pink flowers spring sunshine' },
  ...
  { id: 't16', word: 'September', translations: { es: 'Septiembre', pt: 'Setembro',   fr: 'Septembre', de: 'September',   it: 'Settembre', ja: '9月',  zh: '九月',  ko: '9월',  ar: 'سبتمبر'   , hi: 'सितंबर', ru: 'сентябрь', tr: 'Eylül'}, category: 'Months', unsplashQuery: 'september vineyard harvest golden light countryside' },
  ...
  { id: 't18', word: 'November',  translations: { es: 'Noviembre',  pt: 'Novembro',   fr: 'Novembre',  de: 'November',    it: 'Novembre',  ja: '11月', zh: '十一月', ko: '11월', ar: 'نوفمبر'   }, category: 'Months', unsplashQuery: 'november misty forest bare trees moody atmospheric light' },
  ...
  // Seasons
  { id: 't20', word: 'Spring', translations: { es: 'Primavera', pt: 'Primavera', fr: 'Printemps', de: 'Frühling', it: 'Primavera', ja: '春', zh: '春天', ko: '봄',  ar: 'ربيع'  , hi: 'वसंत', ru: 'Весна', tr: 'Bahar'}, category: 'Seasons', unsplashQuery: 'spring cherry blossom' },
  { id: 't21', word: 'Summer', translations: { es: 'Verano',    pt: 'Verão',     fr: 'Été',       de: 'Sommer',   it: 'Estate',    ja: '夏', zh: '夏天', ko: '여름', ar: 'صيف'   , hi: 'गर्मियाँ', ru: 'Лето', tr: 'Yaz'}, category: 'Seasons', unsplashQuery: 'summer sunny beach' },
  { id: 't22', word: 'Autumn', translations: { es: 'Otoño',     pt: 'Outono',    fr: 'Automne',   de: 'Herbst',   it: 'Autunno',   ja: '秋', zh: '秋天', ko: '가을', ar: 'خريف'  , hi: 'शरद ऋतु', ru: 'Осень', tr: 'Sonbahar'}, category: 'Seasons', unsplashQuery: 'autumn golden orange brown leaves falling forest path' },
  { id: 't23', word: 'Winter', translations: { es: 'Invierno',  pt: 'Inverno',   fr: 'Hiver',     de: 'Winter',   it: 'Inverno',   ja: '冬', zh: '冬天', ko: '겨울', ar: 'شتاء'  , hi: 'शीतकालीन', ru: 'Зима', tr: 'Kış'}, category: 'Seasons', unsplashQuery: 'winter snow cold' },
];
