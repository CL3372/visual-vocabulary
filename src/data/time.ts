...
export const TIME_WORDS: Word[] = [
  ...
  { id: 't16', word: 'September', translations: { es: 'Septiembre', pt: 'Setembro',   fr: 'Septembre', de: 'September',   it: 'Settembre', ja: '9月',  zh: '九月',  ko: '9월',  ar: 'سبتمبر'   }, category: 'Months', unsplashQuery: 'september vineyard harvest golden light countryside' },
  ...
  { id: 't22', word: 'Autumn', translations: { es: 'Otoño',     pt: 'Outono',    fr: 'Automne',   de: 'Herbst',   it: 'Autunno',   ja: '秋', zh: '秋天', ko: '가을', ar: 'خريف'  }, category: 'Seasons', unsplashQuery: 'autumn golden orange brown leaves falling forest path' },
