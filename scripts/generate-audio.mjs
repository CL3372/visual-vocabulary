...
const VOICES = {
  // Neural2 — highest quality (upgraded from WaveNet)
  ...
  // WaveNet — no Neural2 available for these
  ...
  nb:      { languageCode: 'nb-NO',  name: 'nb-NO-Wavenet-F'        },
  da:      { languageCode: 'da-DK',  name: 'da-DK-Neural2-F'        },
  fi:      { languageCode: 'fi-FI',  name: 'fi-FI-Wavenet-B'        },
  ...
  // Worth adding
  hu:      { languageCode: 'hu-HU',  name: 'hu-HU-Wavenet-B'        },
  sk:      { languageCode: 'sk-SK',  name: 'sk-SK-Wavenet-B'        },
  bg:      { languageCode: 'bg-BG',  name: 'bg-BG-Chirp3-HD-Achernar' },
  hr:      { languageCode: 'hr-HR',  name: 'hr-HR-Chirp3-HD-Achernar' },
  sr:      { languageCode: 'sr-RS',  name: 'sr-RS-Chirp3-HD-Achernar' },
  lt:      { languageCode: 'lt-LT',  name: 'lt-LT-Chirp3-HD-Achernar' },
  lv:      { languageCode: 'lv-LV',  name: 'lv-LV-Chirp3-HD-Achernar' },
  ur:      { languageCode: 'ur-IN',  name: 'ur-IN-Wavenet-A'        },
  sw:      { languageCode: 'sw-KE',  name: 'sw-KE-Chirp3-HD-Achernar' },
};
